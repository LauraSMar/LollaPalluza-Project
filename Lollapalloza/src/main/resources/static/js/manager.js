const app = Vue.createApp({
    ...
    methods: {
        ...
        erase(idproduct) {
            ...
            axios.post("/api/products/erase", "id=" + idproduct)
                .then(response => {
                    console.log(response.data)
        ...
        editarProd(idProd) {
            ...
            if (idProd != 0 || idProd != "") {
                ...
                if (this.error.length == 0) {
                    axios.post("api/products/updates", {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (this.emailF != "") {
                        ...
                        axios.post("/api/users/erase", "id=" + (this.idUser))
                            .then(res => {
        ...
        botonesChange(){
        let btn = document.getElementById("descripcion")
